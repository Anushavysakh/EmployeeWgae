...
public class Uc14 implements IComputeWage2 {
	...
	public HashMap<String, EmpWageBuilderArray1> companyToTotalWage;
	...
	public void addCompanyEmpWage(String company, int empRatePerHour, int noOfWorkingDays, int maxHrsPerMonth) {
		EmpWageBuilderArray1 companyObj = new EmpWageBuilderArray1(company, empRatePerHour, noOfWorkingDays,
				maxHrsPerMonth);
